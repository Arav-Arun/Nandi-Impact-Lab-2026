...
const D: Record<string, Tri> = {
  ...
  "in.photo": { en: "Photo (optional)", mr: "फोटो (पर्यायी)", hi: "फोटो (वैकल्पिक)" },
  "in.photoHint": { en: "A clear face helps the system match faster.", mr: "स्पष्ट चेहरा जलद जुळणीस मदत करतो.", hi: "स्पष्ट चेहरा तेज़ मिलान में मदद करता है." },
  "in.addPhoto": { en: "Add a photo", mr: "फोटो जोडा", hi: "फोटो जोड़ें" },
  "in.uploading": { en: "Uploading photo", mr: "फोटो अपलोड होत आहे", hi: "फोटो अपलोड हो रहा है" },
  "in.removePhoto": { en: "Remove", mr: "काढा", hi: "हटाएँ" },
  ...
  "op.addPhoto": { en: "Add photo", mr: "फोटो जोडा", hi: "फोटो जोड़ें" },
  "op.photo": { en: "Photo", mr: "फोटो", hi: "फोटो" },
